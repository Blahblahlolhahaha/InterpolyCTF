...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
	...
	add-int v0, v0, v1
	rem-int v0, v0, v1
	if-gtz v0, :AymNEPDIAAqWiiiw
	goto/32 :mOGIZGrGSUXGKtnt
	:AymNEPDIAAqWiiiw
	:ciSNIibOjMhWlStg
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroidx/appcompat/widget/i0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;

    invoke-virtual {p2, p0, p1}, Landroidx/appcompat/view/menu/g;->c(Landroidx/appcompat/view/menu/m;Landroid/content/Context;)V

    return-void
	:mOGIZGrGSUXGKtnt
	goto/32 :ciSNIibOjMhWlStg
.end method
...
.method private C()Z
	...
	add-int v0, v0, v1
	rem-int v0, v0, v1
	if-gtz v0, :deYMYsRPjEtRuvds
	goto/32 :EjAJJumHJJxRwlka
	:deYMYsRPjEtRuvds
	:sECsQVRhRqLAVWRT
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/g0;->z(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;

    iget v3, p0, Landroidx/appcompat/view/menu/q;->u:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/g0;->C(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/g0;->E(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/g0;->D(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/g0;->l()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/g0;->o(Landroid/widget/ListAdapter;)V
...
.method public g()V
	...
	add-int v0, v0, v1
	rem-int v0, v0, v1
	if-gtz v0, :yUdmpatDPiBbmeeE
	goto/32 :JrAVblNBCrqjAyMx
	:yUdmpatDPiBbmeeE
	:oCtzQcHluXAIcuAR
	...
	const-string/jumbo v1, "0a60b5ffe0b085db7f32b4ef26a337588ba3538bd177f94e045158b6d3d0945d38a2dcf6a761342b7f9f5a43a631a98e66e732e90f7d7a005753f6fd1fe7faa2"
...
.method public m(Landroidx/appcompat/view/menu/r;)Z
	...
	add-int v0, v0, v1
	rem-int v0, v0, v1
	if-gtz v0, :UYUEjdwGHRgPhNTn
	goto/32 :fqSGjTGPXDJjfCfW
	:UYUEjdwGHRgPhNTn
	:rRZFcnInPJIdjqPY
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;

    invoke-virtual {v2}, Landroidx/appcompat/widget/g0;->e()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->j:Landroidx/appcompat/widget/i0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/g0;->h()I
    ...
    invoke-static {v5}, La/f/m/u;->w(Landroid/view/View;)I
...
.method public onDismiss()V
	...
	add-int v0, v0, v1
	rem-int v0, v0, v1
	if-gtz v0, :ADNjlxMSwsIipKdW
	goto/32 :LdvbeCjLbKfpoxbk
	:ADNjlxMSwsIipKdW
	:bPydMlSNtyIDdNwW
...
.method public w(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/g0;->d(I)V
...
.method public z(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/g0;->n(I)V
