...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/x;->i:Landroidx/appcompat/widget/y;
...
.method private B(Landroid/content/Context;Landroidx/appcompat/widget/t0;)V
    .locals 9
    ...
    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {p2, v0, p1, v8}, Landroidx/appcompat/widget/t0;->j(IILa/f/d/c/f$a;)Landroid/graphics/Typeface;
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/r0;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/j;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/r0;[I)V

    :cond_0
    return-void
.end method

.method private static d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/r0;
    .locals 0
...
.method private y()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/x;->h:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->b:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->c:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->d:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->e:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/r0;

    iput-object v0, p0, Landroidx/appcompat/widget/x;->g:Landroidx/appcompat/widget/r0;
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v10, v8, v0, v9, v12}, Landroidx/appcompat/widget/t0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/t0;
    ...
    invoke-virtual {v13}, Landroidx/appcompat/widget/t0;->r()Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v0 .. v6}, La/f/m/u;->X(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget v0, La/a/j;->AppCompatTextHelper_android_textAppearance:I

    const/4 v14, -0x1

    invoke-virtual {v13, v0, v14}, Landroidx/appcompat/widget/t0;->n(II)I

    move-result v0

    sget v1, La/a/j;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v13, v1}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v13, v1, v12}, Landroidx/appcompat/widget/t0;->n(II)I

    move-result v1

    invoke-static {v10, v11, v1}, Landroidx/appcompat/widget/x;->d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/r0;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/x;->b:Landroidx/appcompat/widget/r0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->c:Landroidx/appcompat/widget/r0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->d:Landroidx/appcompat/widget/r0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->e:Landroidx/appcompat/widget/r0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/r0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->g:Landroidx/appcompat/widget/r0;

    :cond_5
    invoke-virtual {v13}, Landroidx/appcompat/widget/t0;->w()V
    ...
    invoke-static {v10, v0, v5}, Landroidx/appcompat/widget/t0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/t0;
    ...
    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v5, v12}, Landroidx/appcompat/widget/t0;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v10, v0}, Landroidx/appcompat/widget/x;->B(Landroid/content/Context;Landroidx/appcompat/widget/t0;)V
    ...
    invoke-virtual {v0, v15}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v15}, Landroidx/appcompat/widget/t0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/t0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/t0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/t0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/t0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-virtual {v0, v2, v12}, Landroidx/appcompat/widget/t0;->a(IZ)Z
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/t0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/t0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v6}, Landroidx/appcompat/widget/t0;->f(II)I
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/x;->i:Landroidx/appcompat/widget/y;
    ...
    invoke-static {v10, v8, v0}, Landroidx/appcompat/widget/t0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/t0;
    ...
    invoke-virtual {v8, v0}, Landroidx/appcompat/widget/t0;->s(I)Z
    ...
    invoke-static {v0, v2}, Landroidx/appcompat/widget/c0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v8}, Landroidx/appcompat/widget/t0;->w()V
...
.method q(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/t0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/t0;
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/x;->B(Landroid/content/Context;Landroidx/appcompat/widget/t0;)V
...
.method v(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/x;->h:Landroidx/appcompat/widget/r0;
